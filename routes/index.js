 ...
 *
 * Nothing else here touches your auth/theme/footer/etc.
 */
...
const FALLBACK = {
  trending: [
    ...
    },
    {
      ...
      cover:
        "https://www.gutenberg.org/cache/epub/30155/pg30155.cover.medium.jpg",
      href: "/read?provider=gutenberg&id=30155",
      subjects: ["Science", "Physics"],
    },
    {
      id: "ol-benfranklin-autobio",
      provider: "openlibrary",
  ...
  science: [
    ...
    },
    {
      ...
      href: "/read?provider=gutenberg&id=15491",
      subjects: ["Science"],
    },
  ],
};
...
const norm = (b = {}) => ({
  ...
  href:
    b.href ||
    `/read?provider=${encodeURIComponent(b.provider || "openlibrary")}&id=${encodeURIComponent(
      b.id || ""
    )}`,
...
// ---- routes ----
router.get("/", (req, res) => {
  // If another part of the app populates shelves, it will appear here:
...
// simple static pages (leave content to your existing views if any)
